...
$lists = array(
	...
	'EnergizedGoogleVideo' => 'https://raw.githubusercontent.com/AdroitAdorKhan/Energized/master/EnergizedHosts/EnergizedGV'
...
foreach ( $lists as $name => $list ) {
	...
	// Output the file.
	file_put_contents( "energized/{$name}.txt", $hosts );
